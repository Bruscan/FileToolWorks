...
export default function AacToMp3() {
  ...
  const handleFileSelect = (files: FileList | null) => {
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      const isValidType = file.type === "audio/aac" ||
    ...
    if (invalidFiles.length > 0) {
      setError(`Invalid file types: ${invalidFiles.join(", ")}. Please select AAC files only.`);
    } else {
      setError(null);
    }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="text-lg text-gray-600 mb-4">
            Convert AAC audio files to MP3 format instantly. Free, fast, and secure.
          </p>
          <p className="text-gray-600 mb-4">
            Upload your AAC files and convert them to MP3 with customizable bitrate. AAC is common on Apple devices and streaming platforms, but MP3 works everywhere. All conversion happens in your browser using WebAssembly, so your files stay private. Need to convert other formats? Try <Link href="/m4a-to-mp3" className="text-blue-600 hover:underline">M4A to MP3</Link>, <Link href="/flac-to-mp3" className="text-blue-600 hover:underline">FLAC to MP3</Link>, or our <Link href="/compress-audio" className="text-blue-600 hover:underline">audio compressor</Link>.
          </p>
          <div className="flex items-center gap-2 mt-4">
            ...
            <span className="text-gray-500">- 132,478 votes</span>
          </div>
        </div>
      </section>
          ...
          {audioFiles.length === 0 ? (
            ...
            >
              ...
              <input
                ref={fileInputRef}
                type="file"
                accept="audio/aac,audio/x-aac,.aac"
                          ...
                          {converted && (
                            <>
                              ...
                              <span className="text-green-600 font-medium">
                                ...
                                {calculateSizeReduction(audioFile.size, converted.size) > 0 && (
              ...
              {convertedAudios.size === 0 && (
                <div className="mb-6">
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    128kbps for smaller files, 192kbps for balanced quality, 320kbps for maximum MP3 quality.
                  </p>
                </div>
              )}
                ...
                <div className="space-y-3">
                  <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                    <p className="text-sm text-green-800 font-medium">
                      AAC files converted to MP3 successfully!
                    </p>
                  </div>
                  {audioFiles.length > 1 && (
                    <button
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 md:p-8">
          ...
          <ol className="space-y-3">
            <li className="flex gap-3">
              ...
              <div>
                <strong className="text-gray-900">Upload AAC files</strong>
                <p className="text-gray-600 text-sm">
                  Click or drag and drop your AAC audio files. Batch conversion is supported.
                </p>
              </div>
            </li>
            <li className="flex gap-3">
            ...
            <li className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Hit Convert to MP3 and download your files. Both AAC and MP3 are compressed formats, so file sizes stay similar. Want to trim first? Use the <Link href="/trim-audio" className="text-blue-600 hover:underline">Audio Trimmer</Link>.
                </p>
              </div>
            </li>
          </ol>
          ...
          <div className="space-y-4">
            <details className="border-b border-gray-200 pb-4">
              ...
              <p className="mt-2 text-gray-600 text-sm">
                AAC (Advanced Audio Coding) is a compressed audio format used by Apple devices, YouTube, and many streaming services. While AAC offers slightly better quality than MP3 at the same bitrate, MP3 has universal compatibility. Some older devices, car stereos, and media players only support MP3. Converting AAC to MP3 ensures your audio plays everywhere.
              </p>
            </details>
            <details className="border-b border-gray-200 pb-4">
              <summary className="font-semibold text-gray-900 cursor-pointer">
              ...
              <p className="mt-2 text-gray-600 text-sm">
                For music, 192kbps or 320kbps provides excellent quality. 128kbps is fine for spoken content like podcasts and audiobooks. Since AAC and MP3 are both lossy formats, use the highest bitrate you can to preserve quality. See our <Link href="/blog/aac-vs-mp3" className="text-blue-600 hover:underline">AAC vs MP3 comparison</Link> for details.
              </p>
            </details>
            <details className="border-b border-gray-200 pb-4">
              <summary className="font-semibold text-gray-900 cursor-pointer">
              ...
              <p className="mt-2 text-gray-600 text-sm">
                AAC and MP3 are both compressed formats, so the file size stays roughly the same at equivalent bitrates. AAC is slightly more efficient, so an AAC file at 128kbps may produce a marginally larger MP3 at 128kbps. The difference is minimal.
              </p>
            </details>
            <details className="border-b border-gray-200 pb-4">
              <summary className="font-semibold text-gray-900 cursor-pointer">
              ...
              <p className="mt-2 text-gray-600 text-sm">
                No. All conversion happens in your browser using WebAssembly (FFmpeg compiled for the web). Your AAC files never leave your device. Nothing is uploaded, stored, or tracked. Learn more on our <Link href="/security" className="text-blue-600 hover:underline">security page</Link>.
              </p>
            </details>
            <details className="border-b border-gray-200 pb-4">
              <summary className="font-semibold text-gray-900 cursor-pointer">
                Can I convert M4A files here too?
              </summary>
              <p className="mt-2 text-gray-600 text-sm">
                M4A files use AAC encoding inside an MP4 container. For M4A files, use our dedicated <Link href="/m4a-to-mp3" className="text-blue-600 hover:underline">M4A to MP3 converter</Link> which handles the container format properly. This tool is specifically for raw AAC files.
              </p>
            </details>
            <details className="border-b border-gray-200 pb-4">
              <summary className="font-semibold text-gray-900 cursor-pointer">
      ...
      {/* Related Tools */}
      <RelatedTools currentToolId="aac-to-mp3" />
    </div>
  );
}
