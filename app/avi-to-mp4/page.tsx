...
export default function AviToMp4() {
  ...
  const handleFileSelect = useCallback((fileList: FileList | null) => {
    ...
    Array.from(fileList).forEach((file) => {
      const isValid = file.type === "video/avi" ||
    ...
    if (invalidFiles.length > 0) {
      setError(`Not AVI files: ${invalidFiles.join(", ")}. Please select .avi files only.`);
    } else {
      setError(null);
    }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="text-lg text-gray-600 mb-4">
            Convert AVI video files to MP4 format online. Free, fast, and private.
          </p>
          <p className="text-gray-600 mb-4">
            Upload your AVI files and convert them to modern MP4 format. AVI is a legacy video format from Microsoft that produces very large files and is not supported by most modern devices, browsers, or social media platforms. MP4 gives you smaller files with better quality that play everywhere. All conversion happens in your browser using WebAssembly. Your videos never leave your device. Need to convert other formats? Try <Link href="/mkv-to-mp4" className="text-blue-600 hover:underline">MKV to MP4</Link> or our <Link href="/compress-video" className="text-blue-600 hover:underline">video compressor</Link>.
          </p>
          <div className="flex items-center gap-2 mt-4">
            ...
            <span className="text-gray-500">- 234,712 votes</span>
          </div>
        </div>
      </section>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 md:p-8">
          ...
          {!loadingFFmpeg && videoFiles.length === 0 && convertedVideos.length === 0 ? (
            ...
            >
              ...
              <input
                type="file"
                accept="video/avi,video/x-msvideo,.avi"
                multiple
                  ...
                  <div className="px-4 pb-4 pt-2 border-t border-gray-200 space-y-4">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-2">
                        High quality preserves the most detail. Low quality creates smaller files.
                      </p>
                    </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 md:p-8">
          ...
          <ol className="space-y-3">
            <li className="flex gap-3">
              ...
              <div>
                <strong className="text-gray-900">Upload AVI files</strong>
                <p className="text-gray-600 text-sm">
                  Click or drag and drop your .avi video files. AVI files are typically from older cameras, Windows software, or legacy recordings.
                </p>
              </div>
            </li>
            <li className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Select output quality and resolution. Converting AVI to MP4 often reduces file size significantly while maintaining quality.
                </p>
              </div>
            </li>
            <li className="flex gap-3">
          ...
          <div className="space-y-4">
            <details className="border-b border-gray-200 pb-4">
              ...
              <p className="mt-2 text-gray-600 text-sm">
                AVI is a legacy video format from the 1990s created by Microsoft. AVI files are typically very large because they often use minimal or no compression. Most modern devices, smartphones, smart TVs, and web browsers cannot play AVI files. Converting to MP4 gives you much smaller files that play everywhere.
              </p>
            </details>
            <details className="border-b border-gray-200 pb-4">
              <summary className="font-semibold text-gray-900 cursor-pointer">
              ...
              <p className="mt-2 text-gray-600 text-sm">
                Yes, significantly. AVI files are often uncompressed or minimally compressed, resulting in very large file sizes. Converting to MP4 with H.264 encoding typically reduces file size by 50-80% while maintaining good visual quality. See our <Link href="/blog/avi-vs-mp4" className="text-blue-600 hover:underline">AVI vs MP4 comparison</Link>.
              </p>
            </details>
            <details className="border-b border-gray-200 pb-4">
              <summary className="font-semibold text-gray-900 cursor-pointer">
              ...
              <p className="mt-2 text-gray-600 text-sm">
                AVI files are commonly from older digital cameras, camcorders, screen recording software, Windows Movie Maker, and legacy video editing tools. If you have old video archives in AVI format, converting to MP4 makes them easier to store, share, and play on modern devices.
              </p>
            </details>
            <details className="border-b border-gray-200 pb-4">
              <summary className="font-semibold text-gray-900 cursor-pointer">
            ...
            <details className="border-b border-gray-200 pb-4">
              ...
              <p className="mt-2 text-gray-600 text-sm">
                With High quality setting, the conversion preserves excellent visual quality. Since AVI files often use older codecs, the modern H.264 encoding in MP4 can actually look just as good or better at a fraction of the file size. You lose nothing meaningful.
              </p>
            </details>
            <details className="border-b border-gray-200 pb-4">
              <summary className="font-semibold text-gray-900 cursor-pointer">
              ...
              <p className="mt-2 text-gray-600 text-sm">
                Yes. This AVI to MP4 converter is completely free with no file limits, no signup, and no watermarks. Convert as many videos as you need. You can also <Link href="/compress-video" className="text-blue-600 hover:underline">compress your MP4 videos</Link> or <Link href="/extract-audio" className="text-blue-600 hover:underline">extract audio from your videos</Link>.
              </p>
            </details>
          </div>
        </div>
      ...
      {/* Related Tools */}
      <RelatedTools currentToolId="avi-to-mp4" />
    </div>
  );
}
