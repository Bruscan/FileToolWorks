...
export default function OggToMp3() {
  ...
  const handleFileSelect = (files: FileList | null) => {
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      const isValidType = file.type === "audio/ogg" ||
                         file.type === "audio/x-ogg" ||
    ...
    if (invalidFiles.length > 0) {
      setError(`Invalid file types: ${invalidFiles.join(", ")}. Please select OGG files only.`);
    } else {
      setError(null);
    }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="flex items-center gap-2 mt-4">
            ...
            <span className="text-gray-500">- 119,342 votes</span>
          </div>
        </div>
      </section>
          ...
          {audioFiles.length === 0 ? (
            ...
            >
              ...
              <input
                ref={fileInputRef}
                type="file"
                accept="audio/ogg,audio/x-ogg,application/ogg,.ogg"
                ...
                <div className="space-y-3">
                  <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                    <p className="text-sm text-green-800 font-medium">
                      OGG files converted to MP3 successfully!
                    </p>
                  </div>
                  {audioFiles.length > 1 && (
                    <button
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 md:p-8">
          ...
          <ol className="space-y-3">
            <li className="flex gap-3">
              ...
              <div>
                <strong className="text-gray-900">Upload OGG files</strong>
            ...
            <li className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Hit Convert to MP3 and download your files. OGG and MP3 are similar in size at equivalent quality. Want to trim first? Use the <Link href="/trim-audio" className="text-blue-600 hover:underline">Audio Trimmer</Link>.
                </p>
              </div>
            </li>
          </ol>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 md:p-8">
          ...
          <div className="space-y-4">
            ...
            <details className="border-b border-gray-200 pb-4">
              ...
              <p className="mt-2 text-gray-600 text-sm">
                OGG Vorbis generally offers slightly better quality than MP3 at the same bitrate, especially at lower bitrates (128kbps and below). At 192kbps and above, the difference is hard to notice. The main advantage of OGG is that it is completely open-source and patent-free. See our <Link href="/blog/ogg-vs-mp3" className="text-blue-600 hover:underline">OGG vs MP3 comparison</Link> for details.
              </p>
            </details>
            <details className="border-b border-gray-200 pb-4">
              <summary className="font-semibold text-gray-900 cursor-pointer">
            ...
            <details className="border-b border-gray-200 pb-4">
              ...
              <p className="mt-2 text-gray-600 text-sm">
                No. All conversion happens in your browser using WebAssembly (FFmpeg compiled for the web). Your OGG files never leave your device. Nothing is uploaded, stored, or tracked. Learn more on our <Link href="/security" className="text-blue-600 hover:underline">security page</Link>.
              </p>
            </details>
            <details className="border-b border-gray-200 pb-4">
              <summary className="font-semibold text-gray-900 cursor-pointer">
            ...
            <details className="border-b border-gray-200 pb-4">
              ...
              <p className="mt-2 text-gray-600 text-sm">
                Yes. This OGG to MP3 converter is completely free with no file limits, no signup, and no watermarks. Convert as many files as you need. Check out our other audio tools: <Link href="/compress-audio" className="text-blue-600 hover:underline">Audio Compressor</Link>, <Link href="/flac-to-mp3" className="text-blue-600 hover:underline">FLAC to MP3</Link>, and <Link href="/extract-audio" className="text-blue-600 hover:underline">Extract Audio from Video</Link>.
              </p>
            </details>
          </div>
        </div>
      ...
      {/* Related Tools */}
      <RelatedTools currentToolId="ogg-to-mp3" />
    </div>
  );
}
