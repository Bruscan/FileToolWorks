      ...
      <section className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="flex items-center gap-2 mt-4">
            ...
            <span className="text-gray-500">– 128,456 votes</span>
          </div>
        </div>
      </section>
            ...
            <li className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Click or drag and drop your JPG files. You can add multiple files at once.
                </p>
              </div>
            </li>
            <li className="flex gap-3">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 md:p-8">
          ...
          <div className="space-y-4">
            ...
            <details className="border-b border-gray-200 pb-4">
              ...
              <p className="mt-2 text-gray-600 text-sm">
                Yes. Upload multiple JPG images and they will all be combined into a single PDF file. Each image becomes one page in the PDF.
              </p>
            </details>
            <details className="border-b border-gray-200 pb-4">
              <summary className="font-semibold text-gray-900 cursor-pointer">
