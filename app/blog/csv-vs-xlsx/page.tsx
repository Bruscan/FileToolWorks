    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            Related reading: <Link href="/blog/xls-vs-xlsx" className="text-blue-600 hover:underline">XLS vs XLSX</Link> covers the same format evolution for Excel specifically, <Link href="/blog/doc-vs-docx" className="text-blue-600 hover:underline">DOC vs DOCX</Link> covers a similar transition in word processing, <Link href="/blog/pdf-vs-docx" className="text-blue-600 hover:underline">PDF vs DOCX</Link> helps decide between document formats for sharing, and <Link href="/blog/json-vs-csv" className="text-blue-600 hover:underline">JSON vs CSV</Link> compares the two most common data interchange formats.
          </p>
        </div>
      </article>
    </div>
