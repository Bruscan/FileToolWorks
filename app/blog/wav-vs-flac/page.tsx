    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            Related reading: <Link href="/blog/mp3-vs-wav" className="text-blue-600 hover:underline">MP3 vs WAV</Link> compares lossy and lossless, <Link href="/blog/flac-to-mp3" className="text-blue-600 hover:underline">FLAC to MP3</Link> covers what you lose when converting to lossy, and <Link href="/blog/how-to-compress-wav-files" className="text-blue-600 hover:underline">how to compress WAV files</Link> walks through reducing WAV size step by step. Going the other direction? See <Link href="/blog/mp3-to-wav-conversion" className="text-blue-600 hover:underline">MP3 to WAV conversion</Link>. For the big picture on how compression types differ, read <Link href="/blog/lossless-vs-lossy-compression" className="text-blue-600 hover:underline">lossless vs lossy compression</Link>.
          </p>
        </div>
      </article>
    </div>
