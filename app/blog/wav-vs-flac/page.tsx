    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            Related reading: <Link href="/blog/mp3-vs-wav" className="text-blue-600 hover:underline">MP3 vs WAV</Link> compares lossy and lossless, and <Link href="/blog/flac-to-mp3" className="text-blue-600 hover:underline">FLAC to MP3</Link> covers what you lose when converting to lossy.
          </p>
        </div>
      </article>
    </div>
