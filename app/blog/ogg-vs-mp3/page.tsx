    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            For a broader comparison of web audio options, see our guide on the <Link href="/blog/best-audio-format-for-web" className="text-blue-600 hover:underline">best audio format for web</Link>. For the newer Opus codec used by Discord and WhatsApp, read <Link href="/blog/opus-vs-mp3" className="text-blue-600 hover:underline">Opus vs MP3</Link>. Wondering how AAC compares? Read <Link href="/blog/aac-vs-mp3" className="text-blue-600 hover:underline">AAC vs MP3</Link>. For the M4A format (AAC in an Apple container), see <Link href="/blog/m4a-vs-mp3" className="text-blue-600 hover:underline">M4A vs MP3</Link>.
          </p>
        </div>
      </article>
    </div>
