    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            For more format comparisons, check out <Link href="/blog/m4a-vs-mp3" className="text-blue-600 hover:underline">M4A vs MP3</Link> (M4A is AAC in an Apple container), <Link href="/blog/ogg-vs-mp3" className="text-blue-600 hover:underline">OGG vs MP3</Link>, or <Link href="/blog/best-audio-format-for-web" className="text-blue-600 hover:underline">best audio format for the web</Link>.
          </p>
        </div>
      </article>
    </div>
