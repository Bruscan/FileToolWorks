    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            Related reading: <Link href="/blog/best-image-format-for-web" className="text-blue-600 hover:underline">Best image format for web</Link> covers how SVG fits alongside JPG, PNG, and WebP for web projects, and <Link href="/blog/png-vs-jpg" className="text-blue-600 hover:underline">PNG vs JPG</Link> compares the two main raster formats.
          </p>
        </div>
      </article>
    </div>
