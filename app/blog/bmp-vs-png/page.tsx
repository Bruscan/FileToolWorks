    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            Related reading: <Link href="/blog/png-vs-jpg" className="text-blue-600 hover:underline">PNG vs JPG</Link> covers lossy vs lossless tradeoffs, <Link href="/blog/psd-vs-png" className="text-blue-600 hover:underline">PSD vs PNG</Link> compares editing vs distribution workflows, <Link href="/blog/tiff-vs-png" className="text-blue-600 hover:underline">TIFF vs PNG</Link> compares two lossless formats for different use cases, and <Link href="/blog/png-vs-gif" className="text-blue-600 hover:underline">PNG vs GIF</Link> explains when animation matters.
          </p>
        </div>
      </article>
    </div>
