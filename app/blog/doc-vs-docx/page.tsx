    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            Related reading: <Link href="/blog/pdf-vs-docx" className="text-blue-600 hover:underline">PDF vs DOCX</Link> covers when to use each document format, and <Link href="/blog/how-to-merge-pdf-files" className="text-blue-600 hover:underline">How to Merge PDF Files</Link> helps when you need to combine multiple documents into one.
          </p>
        </div>
      </article>
    </div>
