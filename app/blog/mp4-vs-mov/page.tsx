    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            For a step-by-step walkthrough, see our guide on <Link href="/blog/how-to-convert-mov-to-mp4" className="text-blue-600 hover:underline">how to convert MOV to MP4</Link>. You might also find <Link href="/blog/mov-vs-mkv" className="text-blue-600 hover:underline">MOV vs MKV</Link>, <Link href="/blog/m4v-vs-mp4" className="text-blue-600 hover:underline">M4V vs MP4</Link>, <Link href="/blog/mkv-vs-mp4" className="text-blue-600 hover:underline">MKV vs MP4</Link>, <Link href="/blog/mp4-vs-webm" className="text-blue-600 hover:underline">MP4 vs WebM</Link>, <Link href="/blog/avi-vs-mp4" className="text-blue-600 hover:underline">AVI vs MP4</Link>, or <Link href="/blog/mov-vs-avi" className="text-blue-600 hover:underline">MOV vs AVI</Link> useful if you are choosing between formats. Posting video to social platforms? See <Link href="/blog/best-video-format-for-social-media" className="text-blue-600 hover:underline">best video format for social media</Link>.
          </p>
        </div>
      </article>
    </div>
