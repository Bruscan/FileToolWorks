    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            Need to reduce your video file size? Try our <Link href="/compress-video" className="text-blue-600 hover:underline font-semibold">video compressor</Link> or <Link href="/video-to-mp4" className="text-blue-600 hover:underline font-semibold">video to MP4 converter</Link>. For more on video codecs, see <Link href="/blog/h264-vs-h265" className="text-blue-600 hover:underline">H.264 vs H.265</Link>, <Link href="/blog/how-to-reduce-video-file-size" className="text-blue-600 hover:underline">How to Reduce Video File Size</Link>, and <Link href="/blog/best-video-format-for-social-media" className="text-blue-600 hover:underline">Best Video Format for Social Media</Link>.
          </p>
        </div>
      </article>
    </div>
