    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            Related comparisons: <Link href="/blog/4k-vs-1080p" className="text-blue-600 hover:underline">4K vs 1080p</Link> covers resolution differences that affect codec choice, <Link href="/blog/h264-vs-av1" className="text-blue-600 hover:underline">H.264 vs AV1</Link> compares H.264 to the royalty-free next-gen codec, <Link href="/blog/h264-vs-vp9" className="text-blue-600 hover:underline">H.264 vs VP9</Link> compares H.264 to Google's royalty-free codec, <Link href="/blog/prores-vs-h264" className="text-blue-600 hover:underline">ProRes vs H.264</Link> covers editing vs delivery codecs, <Link href="/blog/av1-vs-h265" className="text-blue-600 hover:underline">AV1 vs H.265</Link> covers the next-generation codec, <Link href="/blog/h265-vs-h266" className="text-blue-600 hover:underline">H.265 vs H.266</Link> previews the VVC successor, <Link href="/blog/vp9-vs-h265" className="text-blue-600 hover:underline">VP9 vs H.265</Link> compares the royalty-free alternative, and <Link href="/blog/mkv-vs-mp4" className="text-blue-600 hover:underline">MKV vs MP4</Link> covers container formats.
          </p>
        </div>
      </article>
    </div>
