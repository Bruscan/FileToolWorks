    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            Related comparisons: <Link href="/blog/prores-vs-h264" className="text-blue-600 hover:underline">ProRes vs H.264</Link> covers editing vs delivery codecs, <Link href="/blog/av1-vs-h265" className="text-blue-600 hover:underline">AV1 vs H.265</Link> covers the next-generation codec, <Link href="/blog/vp9-vs-h265" className="text-blue-600 hover:underline">VP9 vs H.265</Link> compares the royalty-free alternative, <Link href="/blog/mkv-vs-mp4" className="text-blue-600 hover:underline">MKV vs MP4</Link> covers container formats, and <Link href="/blog/mp4-vs-webm" className="text-blue-600 hover:underline">MP4 vs WebM</Link> compares web video containers.
          </p>
        </div>
      </article>
    </div>
