    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            Related comparisons: <Link href="/blog/mkv-vs-mp4" className="text-blue-600 hover:underline">MKV vs MP4</Link> covers container formats, <Link href="/blog/mp4-vs-webm" className="text-blue-600 hover:underline">MP4 vs WebM</Link> compares web video containers, and <Link href="/blog/best-video-format-for-social-media" className="text-blue-600 hover:underline">best video format for social media</Link> explains which format to pick for uploads.
          </p>
        </div>
      </article>
    </div>
