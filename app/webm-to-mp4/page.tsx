...
export default function WebmToMp4() {
  ...
  const handleFileSelect = useCallback((fileList: FileList | null) => {
    ...
    Array.from(fileList).forEach((file) => {
      const isValid = file.type === "video/webm" ||
    ...
    if (invalidFiles.length > 0) {
      setError(`Not WebM files: ${invalidFiles.join(", ")}. Please select .webm files only.`);
    } else {
      setError(null);
    }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="text-lg text-gray-600 mb-4">
            Convert WebM video files to MP4 format online. Free, fast, and private.
          </p>
          <p className="text-gray-600 mb-4">
            Upload your WebM videos and convert them to MP4 for universal playback. WebM is a web-focused format used by YouTube, Google Chrome, and Firefox, but many devices and media players do not support it. MP4 plays on everything. All conversion happens in your browser using WebAssembly. Your videos never leave your device. Need a different conversion? Try <Link href="/mov-to-mp4" className="text-blue-600 hover:underline">MOV to MP4</Link> or our <Link href="/compress-video" className="text-blue-600 hover:underline">video compressor</Link>.
          </p>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 md:p-8">
          ...
          <ol className="space-y-3">
            <li className="flex gap-3">
              ...
              <div>
                <strong className="text-gray-900">Upload WebM files</strong>
                <p className="text-gray-600 text-sm">
                  Click or drag and drop your .webm video files. These are commonly downloaded from YouTube or recorded in Chrome/Firefox.
                </p>
              </div>
            </li>
            <li className="flex gap-3">
          ...
          <div className="space-y-4">
            <details className="border-b border-gray-200 pb-4">
              ...
              <p className="mt-2 text-gray-600 text-sm">
                WebM is an open format developed by Google that works well in web browsers. However, many devices, media players, and video editing software do not support WebM. MP4 is the universal video standard that works on all phones, TVs, computers, and social media platforms.
              </p>
            </details>
            <details className="border-b border-gray-200 pb-4">
              <summary className="font-semibold text-gray-900 cursor-pointer">
              ...
              <p className="mt-2 text-gray-600 text-sm">
                WebM files are commonly produced by YouTube downloads, screen recordings in Chrome or Firefox, Google services, and web-based video tools. If you have a .webm file that won't play on your phone or TV, converting to MP4 will fix that.
              </p>
            </details>
            <details className="border-b border-gray-200 pb-4">
              <summary className="font-semibold text-gray-900 cursor-pointer">
              ...
              <p className="mt-2 text-gray-600 text-sm">
                The file size depends on the quality setting. At High quality, MP4 files are typically similar in size to the original WebM. WebM (VP9) and MP4 (H.264) are both efficient modern codecs. Lower quality settings will produce smaller MP4 files. Check our <Link href="/blog/mp4-vs-webm" className="text-blue-600 hover:underline">MP4 vs WebM comparison</Link>.
              </p>
            </details>
            <details className="border-b border-gray-200 pb-4">
              <summary className="font-semibold text-gray-900 cursor-pointer">
            ...
            <details className="border-b border-gray-200 pb-4">
              <summary className="font-semibold text-gray-900 cursor-pointer">
                Can I convert WebM audio-only files?
              </summary>
              <p className="mt-2 text-gray-600 text-sm">
                This tool is designed for video WebM files. If you have audio-only WebM/Opus files, you can still convert them but the output will be an MP4 container with just the audio track. For audio conversion, try our <Link href="/compress-audio" className="text-blue-600 hover:underline">audio compressor</Link>.
              </p>
            </details>
            <details className="border-b border-gray-200 pb-4">
              <summary className="font-semibold text-gray-900 cursor-pointer">
      ...
      {/* Related Tools */}
      <RelatedTools currentToolId="webm-to-mp4" />
    </div>
  );
}
